...
class InsertBatchRecordMedicineBody extends StatelessWidget {
  @override
          ...
          () => Column(
            ...
            children: [
                    ...
                    child: BackGroundTextField(
                      ...
                      child: TypeAheadField<MedicineResultSearch>(
                        ...
                        onSuggestionSelected: (MedicineResultSearch result) {
                          ...
                          // bmc.medicineName.value = result.name;
              ...
              Row(
                ...
                children: [
                  BoxInput(
                    title: bmc.unitMedicineSelect.isNotEmpty
                        ? QUATITY_MEDICINE +
                            " (${bmc.unitMedicineSelect.value})"
                        : QUATITY_MEDICINE,
                    child: RoundedInputField(
                ...
                BoxInput(
                  ...
                  child: DatePick(
                    onChanged: (value) {
                      ...
                      bmc.dateWarningExpiration.value =
                          GeneralHelper.subtractDate(value);
                      bmc.warningDateController.text =
                          GeneralHelper.subtractDate(value);
                    },
                  ),
                ),
                Obx(() => BoxInput(
                      ...
                      child: DatePick(
                        ...
                        controller: new TextEditingController(
                            text: bmc.dateExpiration.value != ""
                                ? GeneralHelper.subtractDate(
                                    bmc.dateExpiration.value)
                                : null),
                      ),
                    )),
              ]),
              Padding(
                ...
                child: Center(
                  child: RoundedButton(
                    ...
                    text: "Nhập vào lô",
                    press: () {
                      if (Get.parameters['local'] == "false") {
                        bmc.insertMedicineImport();
                      } else {
                        bmc.addNewMedicineToBatchLocal();
                      }
                    },
                  ),
                ),
